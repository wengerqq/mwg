...
<!--      </el-form-item>-->
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['rchives:currency:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['rchives:currency:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['rchives:currency:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['rchives:currency:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="currencyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="币种ID" align="center" prop="id" />
      <el-table-column label="币种名称" align="center" prop="currencyName" />
      <el-table-column label="币种代码" align="center" prop="currencyCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="币种代码" prop="currencyCode">
          <el-input v-model="form.currencyCode" placeholder="请输入币种代码" />
        </el-form-item>
<!--        <el-form-item label="操作人ID" prop="operatorId">-->
...
<script>
import { listCurrency, getCurrency, delCurrency, addCurrency, updateCurrency } from "@/api/rchives/currency";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('rchives/currency/export', {
        ...this.queryParams
