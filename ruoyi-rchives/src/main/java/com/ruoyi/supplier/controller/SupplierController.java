 ...
 */
@RestController
@RequestMapping("/rchives/supplier")
public class SupplierController extends BaseController
{
     ...
     * 查询供应商管理列表
     */
    @PreAuthorize("@ss.hasPermi('rchives:supplier:list')")
    @GetMapping("/list")
     ...
     * 导出供应商管理列表
     */
    @PreAuthorize("@ss.hasPermi('rchives:supplier:export')")
     ...
     * 获取供应商管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('rchives:supplier:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增供应商管理
     */
    @PreAuthorize("@ss.hasPermi('rchives:supplier:add')")
     ...
     * 修改供应商管理
     */
    @PreAuthorize("@ss.hasPermi('rchives:supplier:edit')")
     ...
     * 删除供应商管理
     */
    @PreAuthorize("@ss.hasPermi('rchives:supplier:remove')")
